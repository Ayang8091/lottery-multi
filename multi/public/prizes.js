...
(function (root) {
  ...
  // ---------- 数字彩规则 / 奖金 ----------
  ML.P3_PRIZES = [ // 排列3 / 福彩3D 同结构
    { mode: 'direct', name: '直选(单选)', desc: '3 位号码与开奖号码逐位完全相同', prize: 1040, prob: 1 / 1000 },
    { mode: 'group3', name: '组选3', desc: '3 位号码有且仅有 2 位相同、顺序不限', prize: 346, prob: 3 / 1000 },
    { mode: 'group6', name: '组选6', desc: '3 位号码各不相同、顺序不限', prize: 173, prob: 6 / 1000 },
  ];
